...
module.exports = function( data ){
  return `server {
    ...
    location /registry/ {
      Proxy_Pass /wedding-registry https://${data.domainPrefix}.bloomingdales.fds.com/wedding-registry/
      Proxy_Pass /registry https://${data.domainPrefix}.bloomingdales.fds.com:9443/registry
    }
