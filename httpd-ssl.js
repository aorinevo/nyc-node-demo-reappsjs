...
function updateHttpdSslFile( domainPrefix ){
  if( !fs.existsSync('/etc/apache2/extra/httpd-ssl.conf') || argv.force ){
    ...
    winston.log( 'info', '/etc/apache2/extra/httpd-ssl.conf already exists. To replace this file, run with --force');
  }
}

module.exports = {
  update: updateHttpdSslFile
};